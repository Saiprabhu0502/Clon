...
var ae = [":", "[", ".", "#"];
function ce(e2) {
  var t2, n2, r2, o2, i2 = void 0 === e2 ? E : e2, s2 = i2.options, a2 = void 0 === s2 ? E : s2, c2 = i2.plugins, u2 = void 0 === c2 ? w : c2, l2 = new stylis_browser_esm_default(a2), d2 = [], h2 = /* @__PURE__ */ function(e3) {
    function t3(t4) {
      if (t4)
        try {
          e3(t4 + "}");
    ...
    return 0 === r3 && -1 !== ae.indexOf(i3[n2.length]) || i3.match(o2) ? e3 : "." + t2;
  };
...
function Ne(e2, n2, r2, o2) {
  ...
  return e2 instanceof ve ? r2 ? (e2.inject(r2, o2), e2.getName(o2)) : e2 : S(e2) ? function e3(t2, n3) {
    var r3, o3, i3 = [];
    for (var s3 in t2)
      t2.hasOwnProperty(s3) && !_e(t2[s3]) && (S(t2[s3]) ? i3.push.apply(i3, e3(t2[s3], s3)) : b(t2[s3]) ? i3.push(be(s3) + ":", t2[s3], ";") : i3.push(be(s3) + ": " + (r3 = s3, null == (o3 = t2[s3]) || "boolean" == typeof o3 || "" === o3 ? "" : "number" != typeof o3 || 0 === o3 || r3 in unitless_browser_esm_default ? String(o3).trim() : o3 + "px") + ";"));
...
function Ye(e2, t2, n2) {
  var o2 = N(e2), s2 = !ke(e2), a2 = t2.attrs, c2 = void 0 === a2 ? w : a2, d2 = t2.componentId, h2 = void 0 === d2 ? function(e3, t3) {
  ...
  var C2, I2 = new ie(n2, g2, o2 ? e2.componentStyle : void 0), P2 = I2.isStatic && 0 === c2.length, O2 = function(e3, t3) {
      ...
      var f2 = function(e5, t5, n4) {
        ...
        return n4.forEach(function(e6) {
          ...
          for (t6 in b(s4) && (s4 = s4(r3)), s4)
            r3[t6] = o4[t6] = "className" === t6 ? (n5 = o4[t6], i2 = s4[t6], n5 && i2 ? n5 + " " + i2 : n5 || i2) : s4[t6];
        }), [r3, o4];
  ...
  } }), Pe(f, g2), C2.warnTooManyClasses = /* @__PURE__ */ function(e3, t3) {
    var n3 = {}, r2 = false;
    return function(o3) {
